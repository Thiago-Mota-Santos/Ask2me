  ...
  <div tw="flex items-center justify-center">
    <div tw="flex flex-col items-center justify-center bg-gray-200 p-8 rounded-lg">
      ...
      <div tw="flex p-12 pt-6">
        <span tw="font-bold text-4xl">Você gosta de queijo?</span>
      </div>
      <div tw="flex flex-col items-center justify-center p-6 bg-orange-500 rounded-lg">
        <span tw="text-white text-2xl">Faça uma pergunta também!</span>
        <span tw="text-xl font-bold text-white">ask2me-next.vercel.app/thiago</span>
      </div>
    </div>
  </div>
</div>
