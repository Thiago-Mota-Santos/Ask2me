/**
 * @generated SignedSource<<98d3dd17add9f9ceb52ed5030708e2a0>>
...
export type QuestionDetails_question$data = {
  readonly questions: {
  ...
  readonly " $fragmentType": "QuestionDetails_question";
};
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": require('./QuestionListPaginationQuery.graphql')
    }
  },
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__QuestionList_questions_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
